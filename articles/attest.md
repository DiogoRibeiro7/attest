...
#> ℹ Certificate 530ca4af7635 issued 2026-09-22 22:06:56 UTC (valid)
```
...
#> 
#> issued 2026-09-22 22:06:56 UTC | status valid | on_fail "refuse"
...
#> ℹ Certificate a992b1d0f204 issued 2026-09-22 22:07:01 UTC (valid)
```
...
#> 
#> Certificate `530ca4af7635`, issued 2026-09-22 22:06:56 UTC, status **valid** (on_fail = `refuse`), attest 0.1.0.
#> 
#> - Engine: `glm`
...
led
#> <attest_ledger> /tmp/RtmpAqaKrP/attest-ledger.ndjson -- 2 entries
```
